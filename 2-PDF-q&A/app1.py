...
if st.button("Submit"):
    if user_input:
        ...
        sys_prompt = '''
            You are an assistant for question-answering tasks in the domain of Indian Law. You are supposed to assist law students and legal professionals. Use the following pieces of retrieved context to answer the question. 
